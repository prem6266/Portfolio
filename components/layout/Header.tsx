...
const Header = () => {
  ...
  return (
    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/85 backdrop-blur-md border-b" : ""
        }`}
    >
          ...
          <Link href={"/"} className="text-xl font-bold text-primary">
            <Avatar className="hover:scale-110 transition-transform">
              <AvatarImage
                ...
                loading="eager"
              />
              <AvatarFallback className="bg-primary text-primary-foreground" delayMs={1000}>
                PJ
              </AvatarFallback>
            </Avatar>
          </Link>
